...
while True:
    ...
    try:
        ...
        print('\n*** INPUT ERROR ***\nInput value of Length and Height should be a Number and not empty.\n')
        continue
    print('==========================================================\n')
